...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div className={`sm-scope z-40 pointer-events-none ${isFixed ? 'fixed top-0 left-0 w-screen h-dvh overflow-hidden' : 'w-full h-full'}`}>
      <div
        className={
          (className ? className + ' ' : '') +
          'staggered-menu-wrapper group pointer-events-none relative w-full h-full z-40'
        }
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between border-b border-white/10 bg-white/20 p-[1.25em_1.5em] backdrop-blur-xl transition-colors duration-300 pointer-events-none z-20 dark:border-white/5 dark:bg-[#0d0d0d]/30 group-data-[open]:border-transparent group-data-[open]:bg-transparent group-data-[open]:backdrop-blur-none"
      ...
      <div className="flex items-center gap-3 pointer-events-auto">
        <span className="sm-header-actions">{headerActions}</span>
          <button
            ref={toggleBtnRef}
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-white dark:bg-[#0d0d0d] flex flex-col p-[5em_2em_2em_2em] overflow-y-auto z-10 pointer-events-auto"
          aria-hidden={!open}
        >
          <div className="sm-panel-inner flex-1 flex flex-col justify-center gap-8">
            <ul
